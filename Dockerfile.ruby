...
RUN PKG_CONFIG_PATH=/usr/lib/openssl-1.0/pkgconfig CC=/usr/bin/gcc-6 RUBY_MAKE_OPTS='-j 5' ruby-build 2.2.0 /opt/rubies/ruby-2.2.0
...
RUN /opt/rubies/ruby-2.2.0/bin/gem install bundler
